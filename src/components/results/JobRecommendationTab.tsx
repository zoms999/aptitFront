    ...
    <ResultCard className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {recommendations.map((rec: any, index: number) => (
          <div key={index} className="bg-gray-50/80 border border-gray-200/80 rounded-xl p-4 flex items-center space-x-4 hover:bg-white hover:shadow-sm transition-all cursor-pointer">
